    ...
    <footer className="relative mt-24 border-t border-border bg-ink/60">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 font-mono text-[11px] uppercase tracking-widest text-cash/80">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <Link href="/rates" className="hover:text-cash">
                Rate Atlas
              </Link>
            </li>
            <li>
              <Link href="/laws" className="hover:text-cash">
                Law Tracker
              </Link>
            </li>
            <li>
              <Link href="/calculator" className="hover:text-cash">
                Debt Lab
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <Link href="/alternatives" className="hover:text-cash">
                Escape Hatch
              </Link>
            </li>
            <li>
              <Link href="/resources" className="hover:text-cash">
                Survival Kit
              </Link>
            </li>
            <li>
