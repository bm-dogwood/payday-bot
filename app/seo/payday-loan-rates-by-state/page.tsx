      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-6">
          <ol className="flex gap-2">
            ...
            <li>/</li>
            <li>
              <a href="/payday-loan-rates">Rates by State</a>
            </li>
            <li>/</li>
        ...
        <section className="prose max-w-none mb-10">
          <p>
            Payday loan costs vary dramatically across the United States. In
            states with no APR caps, borrowers can pay effective annual interest
            rates exceeding 600%. In states that have enacted rate-cap
            legislation, the same loan might cost 90% less. This guide documents
            current payday loan rates, fee structures, and maximum loan amounts
            for every state that permits payday lending, along with a list of
            states where payday loans are banned outright.
          </p>
          <p>
            <strong>Key finding:</strong> The median payday loan APR in
            unrestricted states is 391%—but 13 states have eliminated or
            severely restricted payday lending, protecting their residents from
            the debt trap cycle.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Data sourced from state regulatory agencies, NCSL, and CFPB
            disclosures. Updated quarterly.
          </p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            ...
            rate—typically $10 to $30 per $100 borrowed. Federal law (Truth in
            Lending Act) requires lenders to disclose this as an Annual
            Percentage Rate (APR). Because payday loans are typically 14-day
            products, even a &quot;modest&quot; $15 fee translates to a 391% APR
            when annualized.
          </p>
          <p className="text-gray-300 leading-relaxed">
            State legislatures set the rules. Some states (like Texas) allow
            lenders to operate through credit service organization (CSO)
            loopholes, avoiding fee caps entirely. Others (like Ohio since 2019
            and Illinois since 2021) have enacted hard 28-36% APR caps,
            effectively ending traditional payday lending in those markets.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            Seven states plus D.C. have capped payday loan APRs at 36% or below:
            Colorado, Illinois, Montana, New Hampshire, New Mexico, Ohio,
            Oregon, South Dakota, and Virginia. In these states, a $500 payday
            loan for 14 days costs roughly $7 in fees—compared to $75 or more in
            high-rate states.
          </p>
          <p className="text-gray-300 leading-relaxed">
            If you live in a rate-capped state, you still have access to payday
            loans but at a fraction of the national average cost. Use our{" "}
            <a
              href="/payday-loan-rates"
              className="text-blue-400 hover:underline"
            >
              rate comparison tool
            </a>{" "}
            to find regulated lenders in your state.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            When borrowers cannot repay a payday loan on the due date, many
            states allow (or don&apos;t prohibit) loan rollovers—extending the
            loan for another fee. A $300 loan in Mississippi with a $60 fee,
            rolled over four times, turns a $60 charge into $300 in fees alone—a
            100% return of the original principal in fees.
          </p>
          <p className="text-gray-300 leading-relaxed">
            Use our{" "}
            <a
            ...
            to model the exact cost of rollovers for your specific loan amount
            and state.
          </p>
        </section>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              <a
                ...
                className="text-blue-400 hover:underline"
              >
                Complete guide to payday loan laws by state
              </a>
            </li>
            <li>
              →{" "}
