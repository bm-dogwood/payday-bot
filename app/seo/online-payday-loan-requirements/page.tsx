...
const REQUIREMENTS = [
  ...
  },
  {
    ...
    icon: "🏠",
    required: [
      "Must reside in a state where payday lending is legal",
      "Proof of address may be required (utility bill, lease)",
    ],
  ...
  },
  {
    ...
    icon: "💰",
    required: [
      "Regular income (employment, benefits, or other verifiable source)",
      "Minimum $800–$1,000/month in most cases",
      "Recent pay stubs or bank statements showing income deposits",
    ],
    optional: [
      "Self-employment income accepted by some lenders with bank statement verification",
    ],
  },
  {
    ...
    required: [
      ...
      "Account must support direct deposit and ACH debit",
      "Account typically must be open 30–90 days",
    ],
    optional: [
      "Savings account sometimes accepted but less common",
      "Prepaid debit cards rarely accepted for online loans",
    ],
  },
  {
    ...
    icon: "📱",
    required: [
      "Working phone number (cell preferred)",
      "Valid email address",
      "Ability to receive verification calls or texts",
    ],
    optional: [],
  },
  {
    ...
    icon: "📋",
    required: [
      "Many states restrict having multiple payday loans simultaneously",
      "Lenders check specialty databases (Teletrack, Clarity, DataX) for existing loans",
      "Outstanding defaults or unpaid payday loans often result in denial",
    ],
    optional: [],
  },
];
...
const STATE_ELIGIBILITY = [
  {
    ...
    minLoan: "$100",
    maxLoan: "$300",
    idRequired: "State ID/DL or Passport",
  },
  {
    state: "Florida",
    minAge: 18,
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose max-w-none mb-10">
          <p>
            Payday loans have among the most lenient approval requirements of
            any credit product—by design. Lenders target borrowers with limited
            credit options. But knowing exactly what&apos;s required lets you
            gather documents upfront, avoid unnecessary hard inquiries on
            specialty bureaus, and decide whether a payday loan or a better
            alternative is your best path.
          </p>
          <p>
            <strong>Before applying:</strong> Check whether your state permits
            payday lending. If you&apos;re in a banned or restricted state,
            online lenders claiming to serve your state may be operating
            illegally. Use our{" "}
            <a href="/state-laws" className="text-blue-400 hover:underline">
              state law tracker
            </a>{" "}
            to verify.
          </p>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-6">
            Standard Online Payday Loan Requirements
          </h2>
        ...
        <section className="mb-10">
          ...
          <ol className="space-y-4">
            {[
              {
                title: "Check state eligibility",
                desc: "Confirm payday lending is legal in your state. If banned, your application will be rejected or, worse, you may be dealing with an illegal lender.",
              },
              {
                title: "Compare lenders before applying",
                desc: "Use PAYDAY.BOT's rate comparison tool to find the lowest fee lender in your state. Avoid applying to multiple lenders simultaneously, as this creates multiple records in specialty credit databases.",
              },
              {
                title: "Gather required documents",
                desc: "Have ready: government ID, SSN/ITIN, bank account info (routing + account number), most recent pay stub or bank statement showing income.",
              },
              {
                title: "Complete the online application (5–15 min)",
                desc: "Applications ask for personal info, employment details, income amount and frequency, and bank account details for direct deposit and repayment.",
              },
              {
                title: "Bank account verification",
                desc: "Most lenders use Plaid or similar bank connectivity tools for instant income and account verification. Some require manual bank statement upload.",
              },
              {
                title: "Review loan agreement before signing",
                desc: "Federal law requires the lender to disclose APR, total fees, and repayment terms. Never sign without seeing these disclosures. The APR on a payday loan is typically 300%–664%.",
              },
              {
                title: "Receive funds",
                desc: "Approved loans are typically funded via ACH within 1 business day. Some lenders offer same-day funding for a fee ($10–$30 typically).",
              },
            ].map((step, i) => (
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">
            Eligibility Requirements by State (Selected)
          </h2>
          ...
          <p className="text-xs text-gray-500 mt-2">
            * Alabama requires applicants to be 21+. All other states listed
            require 18+. Check{" "}
            <a href="/state-laws" className="text-blue-400 hover:underline">
              state law tracker
            </a>{" "}
        ...
        <div className="bg-amber-900/20 border border-amber-500/30 rounded-xl p-5 mb-10">
          <h3 className="font-semibold text-amber-400 mb-2">
            ⚠️ Before You Apply: Consider Alternatives
          </h3>
        ...
        <section className="p-6 bg-white/5 rounded-xl">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              >
                10 payday loan alternatives with easier requirements
              </a>
            </li>
            <li>
              →{" "}
