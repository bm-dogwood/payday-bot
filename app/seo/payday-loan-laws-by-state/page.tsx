    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {[
            {
              label: "States Permitting",
              value: "27",
              color: "text-orange-400",
            },
            {
              label: "States Banned/Restricted",
              value: "16",
              color: "text-red-400",
            },
            {
              label: "Rate-Capped States",
              value: "10",
              color: "text-green-400",
            },
            {
              label: "Federal APR Cap (Military)",
              value: "36%",
              color: "text-blue-400",
            },
          ].map((stat) => (
        ...
        <section className="prose max-w-none mb-10">
          <p>
            Payday loan regulation in the United States is a patchwork of state
            laws with no federal interest rate cap (except for military
            borrowers). The result is extreme variation: borrowers in Texas or
            Missouri face virtually unlimited fees, while those in Ohio or
            Colorado are protected by hard APR caps. This guide documents the
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={law.name}
                className="flex gap-4 border border-white/10 rounded-lg p-4"
              >
        ...
        <section className="p-6 bg-white/5 rounded-xl">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              >
                Payday loan rates by state (APR comparison)
              </a>
            </li>
            <li>
              →{" "}
