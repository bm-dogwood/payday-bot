...
const APR_COMPARISONS = [
  ...
  {
    product: "Online personal loan (good credit)",
    apr: "6%–18%",
    type: "good",
  },
...
const FEE_TABLE = [
  ...
  { fee: 17.5, term14: 456, term30: 213 },
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-6">
          <ol className="flex gap-2">
            ...
            <li>/</li>
            <li>
              <a href="/debt-calculator">Calculator</a>
            </li>
            <li>/</li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-10 font-mono text-sm">
          <p className="text-gray-400 mb-2 font-sans font-semibold text-base">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-gray-400 mb-4">
            APR values for common payday loan fees per $100 borrowed, for 14-day
            and 30-day terms.
          </p>
          ...
          <div className="space-y-2">
            {APR_COMPARISONS.map((item) => (
              ...
              >
                ...
                <span
                  className={`text-sm font-mono font-semibold ${typeColor(
                    item.type
                  )}`}
                >
                  {item.apr}
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            Payday lenders market their products using flat fees (&quot;just $15
            per $100&quot;) because fees sound small. $15 doesn&apos;t sound
            dangerous. 391% APR does—because it accurately reflects the cost of
            money over time.
          </p>
          <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            before you sign. If a lender only tells you the flat fee and refuses
            to state the APR, ask directly—or walk away. That&apos;s a red flag.
          </p>
        </section>
        ...
        <section className="p-6 bg-white/5 rounded-xl">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              >
                Payday loan debt trap calculator guide
              </a>
            </li>
            <li>
              →{" "}
