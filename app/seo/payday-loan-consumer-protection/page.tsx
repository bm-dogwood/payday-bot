...
export const metadata: Metadata = buildMetadata(
  SEO_PAGES.seo_consumer_protection
);
...
const FAQS = [
  ...
  {
    question:
      "What can I do if I'm being harassed by a payday loan debt collector?",
    answer:
...
const RIGHTS = [
  {
    ...
    description:
      "Before signing any loan agreement, you have the right to see the Annual Percentage Rate (APR), total dollar amount of fees, and complete repayment terms. This is required by federal law.",
    action:
      "If denied: File a complaint with the CFPB at consumerfinance.gov/complaint",
  },
  {
    title: "Right to Extended Payment Plans",
    description:
      "In many states (AL, AK, FL, ID, IL, IN, IA, KY, LA, MI, MN, MS, MO, NV, NM, ND, OK, OR, SC, UT, VA, WA), you have a legal right to request a free extended repayment plan if you cannot repay on the due date.",
    action:
      "If denied: Contact your state banking regulator and file a complaint.",
  },
  {
    title: "Right Against Unauthorized Debits",
    description:
      "No lender can take money from your bank account without your explicit authorization. After two consecutive failed debit attempts, they must get new authorization before trying again.",
    action:
      "If violated: Contact your bank to revoke authorization and file CFPB complaint.",
  },
  {
    title: "Right Against Harassment",
    description:
      "Debt collectors must follow the FDCPA—no harassment, threats, profanity, false statements, or repeated calls intended to annoy. This applies to the original lender and any third-party collector.",
    action:
      "If harassed: Send cease-and-desist letter, document everything, report to CFPB and FTC.",
  },
  {
    title: "Military Lending Act (Active Duty Only)",
    description:
      "Active-duty servicemembers and their dependents are protected by a 36% APR cap on payday loans, auto title loans, and other covered products. This is federal law and cannot be waived by any loan agreement.",
    action:
      "If violated: Contact your installation's JAG office and the CFPB Military Financial Protection Bureau.",
  },
  {
    title: "Right to Report and Seek Redress",
    description:
      "Every borrower has the right to file regulatory complaints against payday lenders who violate state or federal law. Penalties include fines, license revocation, loan voiding, and repayment of fees.",
    action:
      "Where to report: CFPB, your state banking regulator, state attorney general, FTC.",
  },
];
...
const AGENCIES = [
  {
    ...
    description:
      "Federal agency. File complaints about any financial product including payday loans. Most effective for federal violations.",
  },
  {
    name: "FTC (Federal Trade Commission)",
    url: "https://reportfraud.ftc.gov",
    description:
      "Report deceptive or unfair practices, especially by online lenders. Also handles FDCPA violations.",
  },
  {
    name: "CSBS (Conference of State Bank Supervisors)",
    url: "https://www.csbs.org/consumers",
    description:
      "Directory of state banking regulators. Find your state's regulator for state law violations.",
  },
  {
    name: "NFCC (National Foundation for Credit Counseling)",
    url: "https://www.nfcc.org",
    description:
      "Free and low-cost nonprofit credit counseling. Helps negotiate with payday lenders and develop debt payoff plans.",
  },
  {
    name: "IC3 (Internet Crime Complaint Center)",
    url: "https://www.ic3.gov",
    description:
      "FBI-affiliated. Report online payday loan fraud, phishing, and unlicensed internet lenders.",
  },
  {
    name: "State Attorney General",
    url: "https://www.naag.org/find-my-ag",
    description:
      "File complaints about state consumer protection law violations. Can initiate enforcement actions against licensed and unlicensed lenders.",
  },
];
...
export default function PaydayLoanConsumerProtectionPage() {
  const schemas = [
    articleSchema({
      ...
      description:
        "Detailed guide to payday loan borrower rights under federal and state law.",
    ...
    breadcrumbSchema([
      { name: "Home", url: "https://payday.bot" },
      {
        ...
        url: "https://payday.bot/consumer-protection",
      },
      {
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose max-w-none mb-10">
          <p>
            Payday borrowers have more legal protections than most realize.
            Federal and state laws restrict what lenders can charge, how they
            can collect, and what happens if they violate the rules. This guide
            covers every major borrower right, how to exercise them, and where
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">
            Red Flags: Signs of a Predatory or Illegal Lender
          </h2>
          <div className="grid md:grid-cols-2 gap-2">
            {RED_FLAGS.map((flag) => (
              <div
                key={flag}
                className="flex gap-2 items-start py-2 px-3 bg-red-900/10 border border-red-500/10 rounded-lg"
              >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">
            Where to Report Payday Loan Violations
          </h2>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              ...
              <a
                ...
                className="text-blue-400 hover:underline"
              >
                Full consumer protection resource center
              </a>
            </li>
          </ul>
        </section>
